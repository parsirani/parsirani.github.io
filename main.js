document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateRankText(score) {
        if (score < 1000) {
            rankText.innerHTML = 'لیگ نوح (ع) 🥉'; // اضافه کردن ایموجی برنز
            bodyElement.style.background = 'linear-gradient(180deg,rgb(224, 223, 124),rgb(35, 161, 63))';
            energyBar.style.backgroundColor = '#cd7f32'; /* رنگ نوار شارژ برای لیگ برنزی */
        } else if (score < 5000) {
            rankText.innerHTML = 'لیگ ادریس (ع) 🥈'; // اضافه کردن ایموجی نقره
            bodyElement.style.background = 'linear-gradient(180deg,rgba(170, 233, 238, 0.83),rgb(35, 161, 63))';
            energyBar.style.backgroundColor = '#c0c0c0'; /* رنگ نوار شارژ برای لیگ نقره‌ای */
        } else if (score < 20000) {
            rankText.innerHTML = 'لیگ موسی (ع) 🥇'; // اضافه کردن ایموجی طلا
            bodyElement.style.background = 'linear-gradient(180deg,rgba(236, 214, 14, 0.8),rgb(35, 161, 63))';
            energyBar.style.backgroundColor = '#f9a602'; /* رنگ نوار شارژ برای لیگ طلایی */
        } else {
            rankText.innerHTML = 'لیگ یوسف عزیز مصر (ع) 💎'; // اضافه کردن ایموجی الماس
            bodyElement.style.background = 'linear-gradient(180deg,rgb(71, 103, 172),rgb(35, 161, 63))';
